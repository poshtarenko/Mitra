...
public class SearchController implements GetController {
    ...
    public SearchController(LocationService locationService, InstrumentService instrumentService,
    ...
    public void processGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        ControllerUtils.forward(request, response, GetUrl.SEARCH.getJspFileName());
    }
}
