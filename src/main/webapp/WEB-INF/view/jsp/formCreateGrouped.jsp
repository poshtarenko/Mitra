    ...
    <div class="formBlock">
        <div class="left">
            ...
            <div class="inpt">   
                    ...
                    <!-- <div id="name-input-box" class="input-box email-box">               
                    ...
                    <div id="sex-input-box" class="inpt display-none">
                        <select class="selectpicker w-100" aria-label="Default select example" title="Виберіть стать">
                            <option data-tokens="Чоловік">Чоловік</option>
                            <option data-tokens="Жінка">Жінка</option>
                        </select>
                  </div>
                    ...
                    <!-- <div id="location-input-box" class="inpt display-none">
                          <select class="form-select" aria-label="Default select example" data-live-search="true">
                ...
                <div id="location-input-box" class="inpt display-none">
                    <select class="selectpicker w-100" data-live-search="true" title="Виберіть місто">
                        <option data-tokens="Одеса">Одеса</option>
                        <option data-tokens="Київ">Київ</option>
                        <option data-tokens="Чорноморськ">Чорноморськ</option>
                      </select>
                </div>
