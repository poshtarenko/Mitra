                    ...
                    <div id="profile-main">
                        <div id="photo-and-button">
                            ...
                            <c:if test="${not empty requestScope.alreadyMutualLikes}">
                                <p class="relationship-info-text">Ми дружимо!</p>
                                <c:if test="${not empty requestScope.chatId}">
                                    <form action="${pageContext.request.contextPath}/app/chat" method="get">
                                        ...
                                        <button type="submit" class="like-button">Перейти до чату</button>
                                    </form>
                                    <br>
                                </c:if>
                            ...
                            <c:if test="${not empty requestScope.weRejectedUser}">
                                <p class="relationship-info-text">Ми відмовили цьому користувачеві</p>
                            </c:if>
                        </div>
                        <div id="profile-info">
